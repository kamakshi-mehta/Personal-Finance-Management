...
const Layout = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'checking':
        return (
          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-500 border border-slate-200 animate-pulse">
            Checking...
          </span>
        );
      default:
